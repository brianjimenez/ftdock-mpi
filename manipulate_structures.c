...
void translate_structure_op( struct Structure *This_Structure , float x_shift , float y_shift , float z_shift ) {
  ...
  for( residue = 1 ; residue <= This_Structure->length ; residue ++ ) {
    ...
    for( atom = 1 ; atom <= This_Structure->Residue[residue].size ; atom ++ ) {
      ...
      This_Structure->Residue[residue].Atom[atom].coord[1] += x_shift ;
      This_Structure->Residue[residue].Atom[atom].coord[2] += y_shift ;
      This_Structure->Residue[residue].Atom[atom].coord[3] += z_shift ;
